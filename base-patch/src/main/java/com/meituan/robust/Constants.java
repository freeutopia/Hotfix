...
public class Constants {
  ...
  public static final String MODIFY_ANNOTATION = "com.meituan.robust.annotaion.Modify";
  public static final String ADD_ANNOTATION = "com.meituan.robust.annotaion.Add";

  public static final String PATCH_TEMPLATE_FULL_NAME = "com.meituan.robust.utils.PatchTemplate";
  public static final String PROXY_CLASS_NAME = "com/meituan/robust/PatchProxy";
  ...
  // FILE_MD5_PATH is a copy from RobustTransform.FILE_MD5_PATH ,please make sure the two is the
  // same
  ...
  public static final String INSERT_FIELD_NAME = "$change";
