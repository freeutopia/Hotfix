...
public class EnhancedRobustUtils {
  ...
  public static Object invokeReflectConstruct(
      String className, Object[] parameter, Class<?>[] args) {
    try {
  ...
  public static Object invokeReflectMethod(
      String methodName,
      Object targetObject,
      Object[] parameters,
      Class[] args,
  ...
  public static Method getDeclaredMethod(
      Object object, String methodName, Class[] parameterTypes, Class declaringClass) {
    Method method = null;
  ...
  public static Object invokeReflectStaticMethod(
      String methodName, Class cl, Object[] parameter, Class[] args) {
    try {
    ...
    if (isThrowable) {
      throw new RuntimeException(
          "invokeReflectStaticMethod error " + methodName + "   class   " + cl + "  args  " + args);
    }
    return null;
  }
  ...
  public static void setFieldValue(String name, Object instance, byte value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue byte error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setFieldValue(String name, Object instance, char value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue char error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setFieldValue(String name, Object instance, double value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue double error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setFieldValue(String name, Object instance, float value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue float error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setFieldValue(String name, Object instance, long value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue long error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setFieldValue(String name, Object instance, Object value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue Object error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setFieldValue(String name, Object instance, short value, Class cl) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setFieldValue short error " + name + "   target   " + instance + "  value  " + value);
      }
    }
  }
  ...
  public static void setStaticFieldValue(String name, Class clazz, Object value) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setStaticFieldValue Object error "
                + name
                + "   Class   "
                + clazz
                + "  value  "
  ...
  public static void setStaticFieldValue(String name, Class clazz, int value) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setStaticFieldValue int error " + name + "   Class   " + clazz + "  value  " + value);
      }
    }
  }
  ...
  public static void setStaticFieldValue(String name, Class clazz, boolean value) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setStaticFieldValue boolean error "
                + name
                + "   Class   "
                + clazz
                + "  value  "
  ...
  public static void setStaticFieldValue(String name, Class clazz, float value) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setStaticFieldValue float error "
                + name
                + "   Class   "
                + clazz
                + "  value  "
  ...
  public static void setStaticFieldValue(String name, Class clazz, long value) {
    try {
      ...
      if (isThrowable) {
        throw new RuntimeException(
            "setStaticFieldValue long error " + name + "   Class   " + clazz + "  value  " + value);
      }
    }
  }
  ...
  private static Field getReflectField(String name, Object instance, Class cl)
    ...
    if (cl == null) {
      if (isThrowable) throw new RuntimeException("Field " + name + " declaring class is null ");
      else return null;
    }
    Field field;
    if (!cl.isInterface()) {
